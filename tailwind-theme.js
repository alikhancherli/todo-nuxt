...
export default {
    ...
    global: {
      ...
      input: 'appearance-none border-gray-500 rounded-xl px-2 my-3 border-2 bg-transparent focus:outline-none focus:ring-0 focus:shadow-none',
    ...
    'family:button': {
      input: '$reset inline-flex items-center text-white hidden text-sm font-normal py-3 px-6 rounded focus-visible:outline-2 focus-visible:outline-blue-600 focus-visible:outline-offset-2 formkit-disabled:bg-gray-400 formkit-loading:before:w-4 formkit-loading:before:h-4 formkit-loading:before:mr-2 formkit-loading:before:border formkit-loading:before:border-2 formkit-loading:before:border-r-transparent formkit-loading:before:rounded-3xl formkit-loading:before:border-white formkit-loading:before:animate-spin',
      wrapper: '$remove hidden',
      prefixIcon: '$reset block w-4 -ml-2 mr-2 stretch hidden',
      suffixIcon: '$reset block w-4 ml-2 stretch hidden',
    },
    'family:dropdown': {
    ...
    'family:text': {
      ...
      input: 'w-full px-3 py-2 text-base text-gray-700 placeholder-gray-400',
    },
    'family:date': {
      inner: 'flex items-center max-w-md ring-1 ring-gray-400 focus-within:ring-blue-500 focus-within:ring-2 [&>label:first-child]:focus-within:text-blue-500 rounded mb-1',
